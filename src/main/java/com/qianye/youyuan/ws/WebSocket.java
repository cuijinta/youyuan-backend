package com.qianye.youyuan.ws;

import cn.hutool.core.date.DateUtil;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.google.gson.Gson;
import com.qianye.youyuan.config.HttpSessionConfigurator;
...
import com.qianye.youyuan.model.request.MessageRequest;
...
public class WebSocket {
    ...
    public void onOpen(Session session, @PathParam(value = "userId") String userId, @PathParam(value = "teamId") String teamId, EndpointConfig config) {
        try {
            ...
            User user = (User) httpSession.getAttribute(USER_LOGIN_STATUS);
            if (user != null) {
